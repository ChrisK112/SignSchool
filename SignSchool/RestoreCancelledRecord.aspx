<%@ Page Title="Sense Sign School" Language="C#" MasterPageFile="~/SingSchool.Master" AutoEventWireup="true" CodeBehind="RestoreCancelledRecord.aspx.cs" Inherits="SignSchool.RestoreCancelledRecord" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="PageTitle">Reactivate Record</h1> 
    <br />
    <asp:Table id="DataEditTable" runat="server" CellPadding="5" GridLines="None" BackColor="#E3EAEB" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" TextLayout="TextOnTop" HorizontalAlign="Center">
        ...
        <asp:TableFooterRow>
             <asp:TableCell ColumnSpan="4" HorizontalAlign="Center">
                <asp:Button ID="SaveButton" runat="server" OnClick="SaveButton_Click" Text="Restore Record" />
             </asp:TableCell>
        </asp:TableFooterRow>
    </asp:Table>
