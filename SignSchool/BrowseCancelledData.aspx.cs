...
{
    public partial class BrowseCancelledData : System.Web.UI.Page
    {
        ...
        protected void DisplayData()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from [dbo].[CancelledView] order by [id] DESC", con);
            con.Open();
        ...
        protected void SearchByCriteria(string value, string searchCriteria)
        {
            ...
            {
                using (var cmd = new SqlCommand("select * from [dbo].[CancelledView] WHERE [" + searchCriteria + "] LIKE '%" + value + "%'", con))
                {
