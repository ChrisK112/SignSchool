...
{
    public partial class RestoreCancelledRecord : System.Web.UI.Page
    {
        ...
        private void FillData(string id)
        {
            ...
            {
                using (var cmd = new SqlCommand("select top 1 * from [dbo].[RestoreCancelledView] WHERE [id] = '" + id + "'", con))
                {
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                using (var cmd = new SqlCommand("dbo.RestoreCancelledRecord", con))
                {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Record Restored!')", true);
                Response.Redirect("RestoreCancelledRecordSearch.aspx");
            }
        }
    }
}