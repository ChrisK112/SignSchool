<%@ Page Title="Sense Sign School" Language="C#" MasterPageFile="~/SingSchool.Master" AutoEventWireup="true" CodeBehind="Browse12PacksData.aspx.cs" Inherits="SignSchool.Browse12PacksData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="PageTitle">Browse 12 Pack Records</h1> 
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:DropDownList ID="SearchDropdownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="SearchDropdownList_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="Date Moved to 12Packs" Text="Date 12 Packs Sent"></asp:ListItem>
